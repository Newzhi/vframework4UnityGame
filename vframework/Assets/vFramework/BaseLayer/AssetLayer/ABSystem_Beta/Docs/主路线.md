...
| **6** | **Bundle 依赖拓扑排序** | ✅ `CatalogueWriter` 写序 + 环检测；详见 [Bundle构建优化与拓扑排序计划.md](./Bundle构建优化与拓扑排序计划.md) §2 |
...
| [Bundle构建优化与拓扑排序计划.md](./Bundle构建优化与拓扑排序计划.md) | 拓扑排序 + 构建优化排期 |
| [ResLoader/说明.md](../ResLoader/说明.md) | 加载侧架构图 + 子目录索引 |
| [加载器设计说明.md](../ResLoader/加载器设计说明.md) | 双层架构 + Router 细节 |
