...
> 句柄：`IAssetHandle`  
> 详细排期与能力边界：[业务API与CDN规划.md](./业务API与CDN规划.md)、[主路线.md](./主路线.md)
...
- Editor Play + 清单 `buildMode=EditorTest` 时在 Editor 内走 AssetDatabase；Player 走 AB，见 [ResLoader/说明.md](../ResLoader/说明.md)。  
- Ref 与范例细则见 **§6**；抄代码见 **§7**。
