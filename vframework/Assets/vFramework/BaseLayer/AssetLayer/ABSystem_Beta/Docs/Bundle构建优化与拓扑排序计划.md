...
> **关联**：[Catalogue清单说明.md](./Catalogue清单说明.md)、[主路线.md](./主路线.md)、`Editor/BundleBuilder/`、`ResLoader/Bundle/BundleManager.cs`
...
| 文档 | 更新内容 |
|------|----------|
| [Catalogue清单说明.md](./Catalogue清单说明.md) | §三 补充拓扑序约定；链到本文 |
| [主路线.md](./主路线.md) | P1 增加 #6/#7 |
| [设计目标与实现细节.md](./设计目标与实现细节.md) | 打包器 / 清单 checklist 增行 |
| [Editor/说明.md](../Editor/说明.md) | BundleBuildAnalyzer 职责 |
